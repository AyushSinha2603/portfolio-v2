  ...
  return (
    <>
      ...
      >
        ...
        <div
          ref={heroRef}
          className="flex min-h-screen items-center justify-center px-4 py-20 md:items-center md:justify-start md:px-[5%] md:py-0 overflow-x-hidden"
        >
        ...
        <div
          ref={techRef}
          className="flex min-h-screen items-center justify-center px-4 py-20 md:items-center md:justify-end md:px-[5%] md:py-0 overflow-x-hidden"
        >
          <div className="w-full md:max-w-[40vw]">
            <TechStackSection />
          </div>
